"""Clawd publish payload 的純 domain transform。"""
...
from app.trading.tape_guard import tape_blocks_bullish_language, tape_excludes_primary, tape_guard_from_mapping
...
def build_payload(
    ...
    *,
    ...
    ranking_source = ranking_source_policy(report, project_root=project_root)
    top_items = [
...
def ranking_source_policy(report: dict[str, Any], project_root: Path) -> dict[str, Any]:
