...
SCHEMA_VERSION = "odd-lot-exit-strategy-report-verification.v1"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="verify odd-lot exit strategy report")
    parser.add_argument("--artifact", required=True)
    parser.add_argument("--output", default="artifacts/model_experiments/odd_lot_exit_strategy_report_verification_latest.json")
