...
SCHEMA_VERSION = "odd-lot-candidate-comparison-report-verification.v1"
REPORT_SCHEMA = "odd-lot-candidate-comparison-report.v1"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="verify odd-lot candidate comparison report")
    parser.add_argument("--artifact", required=True)
    parser.add_argument("--output", default="artifacts/model_experiments/odd_lot_candidate_comparison_report_verification_latest.json")
