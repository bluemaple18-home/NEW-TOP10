    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            try:
                ...
                raise AssertionError("preflight without override should fail on incomplete latest market coverage")
            ...
            assert command == ["python", "-m", "app.pipeline_cli", "run", "--end-date", "2026-05-26"]
            assert runner.status.metadata["pipeline_window"] == {"end_date": "2026-05-26"}
