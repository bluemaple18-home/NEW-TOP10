...
SCHEMA_VERSION = "odd-lot-regime-sensitivity-report-verification.v1"
REPORT_SCHEMA = "odd-lot-regime-sensitivity-report.v1"
REQUIRED_REGIMES = {"BIG_BULL", "HIGH_CHOPPY_CONTEXT", "OTHER"}


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="verify odd-lot regime sensitivity report")
    parser.add_argument("--artifact", required=True)
    parser.add_argument("--output", default="artifacts/model_experiments/odd_lot_regime_sensitivity_report_verification_latest.json")
