...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--batch-size", type=int, default=int(os.environ.get("TOP10_REPLAY_DRAIN_BATCH_SIZE", "6")))
    parser.add_argument("--max-batches", type=int, default=int(os.environ.get("TOP10_REPLAY_DRAIN_MAX_BATCHES", "1")))
    parser.add_argument("--max-seconds", type=int, default=int(os.environ.get("TOP10_REPLAY_DRAIN_MAX_SECONDS", "1800")))
