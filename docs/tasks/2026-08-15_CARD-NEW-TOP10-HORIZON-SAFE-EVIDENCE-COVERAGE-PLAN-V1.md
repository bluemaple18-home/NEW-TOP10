---
id: CARD-NEW-TOP10-HORIZON-SAFE-EVIDENCE-COVERAGE-PLAN-V1
...
model: gpt-5.6-terra
reasoning: medium
model_reason: 缺口與 authority 已由 Card E 固定；本卡只產生 deterministic plan，不 materialize ranking、不跑 replay，採節省模式 Terra medium。
date: 2026-08-15
