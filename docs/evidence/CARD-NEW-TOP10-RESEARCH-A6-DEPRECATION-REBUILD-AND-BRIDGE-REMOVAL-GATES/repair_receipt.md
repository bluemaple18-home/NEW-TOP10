...
uv run python scripts/verify_research_spine_a6_closure.py --base-ref bb617e98aabefcc52bbf7cb1834fb5fba715d60a --candidate-ref HEAD --output-root /private/tmp/a6-fixed-sha-output --output /private/tmp/a6-fixed-sha-receipt.json
```

第二個命令只接受不存在的 output root，或含 `.a6-closure-generated-root` marker 的前次 generated root；repository child、corpus、project 與未標記目錄皆 fail closed。
